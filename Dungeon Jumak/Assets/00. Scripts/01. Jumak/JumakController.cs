...
public class JumakController : MonoBehaviour
{
    ...
    [SerializeField] private bool[] m_allocatedSeats;
    ...
    private void Init()
    {
        m_allocatedSeats = new bool[seats.Length];
    ...
    public bool CheckEmptySeat()
    {
        ...
        {
            if (!m_allocatedSeats[i]) return true;   //비어 있는 자리가 하나라도 있다면 True 반환
        }
    ...
    public Transform GetEmptySeat()
    {
        ...
        m_allocatedSeats[random] = true;    //자리 할당
