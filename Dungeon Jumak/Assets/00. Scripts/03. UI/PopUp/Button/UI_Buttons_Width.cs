...
public class UI_Buttons_Width : UI_PopUp
{
    ...
    private void Start()
    {
        ...
        GetButton((int)Buttons.Storage).gameObject.BindEvent(OpenInventoryPopUp);
    ...
    private void OpenInventoryPopUp(PointerEventData _data)
    {
        GameManager.UI.ShowPopupUI<UI_PopUp>("InventoryPopUp");
    }
}
